import { CheckCircle2, LayoutGrid, Scissors, TicketCheck, TriangleAlert } from "lucide-react";
...
export function OperationsPanel({ preset, onPreset, totalCopies, sheets, cropMarks, bleed, onCropMarks, onBleed, preflight, onAutoArrange }: { preset: string; onPreset: (id: string) => void; totalCopies: number; sheets: number; cropMarks: boolean; bleed: boolean; onCropMarks: (value: boolean) => void; onBleed: (value: boolean) => void; preflight: PreflightItem[]; onAutoArrange: () => void }) {
