...
export function DraggablePhoto({ photo, index, fit, selected, onSelect, onPosition }: { photo: PhotoItem; index: number; fit: "cover" | "contain"; selected: boolean; onSelect: (id: string) => void; onPosition: (id: string, x: number, y: number) => void }) {
