...
export function PhotoAdjuster({ photo, index, total, mode, onMode, onDimensions, onReset }: { photo?: PhotoItem; index: number; total: number; mode: "move" | "crop"; onMode: (mode: "move" | "crop") => void; onDimensions: (widthCm: number | null, heightCm: number | null) => void; onReset: () => void }) {
